...
// Load token data
const tokens = JSON.parse(fs.readFileSync('./config/token.json', 'utf-8'));
...
async function main() {
    ...
    // Prompt for the number of transactions per wallet
    const numTransactions = parseInt(await promptUser('Enter the number of transactions to deploy for each wallet: '), 10);
